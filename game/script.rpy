...
label start:
    ...
    shooter:
        ...
        player_gun _shooter.AK47 # Класс оружия игрока. <Опционально. Если нет - рукопашка.>
        ...
        enemy:  # Блок описания врага. Множественный аргумент. <Опционально. (Если ни одного - бой завершится не начавшись.)>
            _multiply 7000  # Количество врагов, которые будут инициализированы с аргументами ниже. <Опционально. Умолчание - 1.>
